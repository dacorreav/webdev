...
"Save coc extensions
let g:coc_global_extensions = ['coc-tabnine', 'coc-stylelintplus', 'coc-snippets', 'coc-prettier', 'coc-pairs', 'coc-just-complete', 'coc-html-css-support', 'coc-html', 'coc-highlight', 'coc-eslint', 'coc-cssmodules', 'coc-tsserver', 'coc-phpls', 'coc-json', 'coc-css']
